...
const LeftLogoSection: React.FC = () => {
  ...
  const [uploadPosition, setUploadPosition] =
    useState<LogoPosition>("leftSide_top");
    ...
    <div className="space-y-6 overflow-x-hidden">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              ...
              <p className="text-amber-700">
                الشعار الثالث في الجهة اليسرى سيكلف{" "}
                {PRICING_CONFIG.additionalCosts.leftSideThirdLogo} ريال إضافي
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <CloudinaryImageUpload
          ...
          className="mb-4"
          aspectRatio={1}
          cropTitle="اقتطاع شعار جانبي أيسر"
        />
      ...
      <div className="p-3 bg-purple-50 rounded-lg text-xs text-purple-700 border border-purple-200">
        <p>
          * أول شعارين مشمولين في السعر الأساسي، يتم إضافة{" "}
          {PRICING_CONFIG.additionalCosts.leftSideThirdLogo} ريال للشعار الثالث
        </p>
        {uploadedImages.length > 0 && (
          <p className="mt-1">
