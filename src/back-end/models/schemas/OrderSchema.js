...
const logoSchema = new mongoose.Schema({
  ...
  position: { 
    ...
    required: true,
    enum: [
      "chestRight", "chestLeft", "backCenter",
      "rightSide_top", "rightSide_middle", "rightSide_bottom",
      "leftSide_top", "leftSide_middle", "leftSide_bottom"
    ]
  },
...
const jacketConfigSchema = new mongoose.Schema({
  ...
  materials: {
    body: { type: String, required: true, default: "cotton", enum: ["cotton", "leather"] },
    sleeves: { type: String, required: true, default: "leather", enum: ["cotton", "leather"] },
    trim: { type: String, required: true, default: "cotton", enum: ["cotton", "leather"] },
  },
  size: { 
    type: String, 
    required: true, 
...
orderSchema.index({ "customerInfo.name": "text", "customerInfo.phone": "text" });
